    ...
    events: [
      {
        ...
        description:
          "Do you own a cookbook you love but never use? Or cherished family recipes that could be creatively commemorated? What about that stack of old food magazines or restaurant menus you can’t seem to let go of? Join MOFAD for a community crafting workshop and transform those cookbooks and recipes into vibrant works of art. With guidance from multi-disciplinary artist and chef, Andrea Lekberg, we’ll chat about our favorite recipes and lean into our creativity at this hands-on collage workshop. We encourage you to bring physical cookbooks, recipes, food magazines, restaurant menus, or anything else you like! Don’t want to cut into a favorite piece? Bring a photocopy! MOFAD will also provide plenty of supplies for you to create for you to create your own cookbook collage to take home. Ticket includes access to Flavor: The World to Your Brain from 6 to 7 PM, baked goods from The Artist Baker, and beverages.",
      ...
      },
      {
        ...
        description:
          "Wild & Scenic Film Festival brings together incredible selections of films that inform, inspire, and ignite solutions and possibilities to restore the earth and human communities while creating a positive future for the next generation. Join the Alliance for the Chesapeake Bay at Studio Two-Three on March 6th, 2025, for award-winning & inspirational films benefitting clean water for all! ",
        time: "2025-03-16T16:00:25.534Z",
        date: "2025-06-13",
        price: "100",
        status: true,
        address: {
