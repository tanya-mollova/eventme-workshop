      ...
      <div className="container">
        <div className="row">
          <div className="col-lg-10 mx-auto">
            {" "}
            <br />
            <h1 class="h1 mb-4 mt-4">Privacy Policy</h1>
            <br />
            <div className="content text-left">
              <h3 id="application-processing">Application Processing</h3>
              <p>
                You are most welcome to share our themes with your
                clients/friends, but please share our license with them so that
                they can be aware of our copyrights.
              </p>
              ...
              <ul>
                <li>
                  You cannot remove the copyright link to Gethugothemes without
                  buying the license.
                </li>
                <li>
              ...
              <p>
                ...
                our Service such as your , email address, PayPal address (if
                different from email address), and telephone number. The
                ...
                collects Slack account and access information from Users for the
                purposes of connecting to and the Slack API and to authenticate
                to information on
              </p>
              <ul>
                <li>
