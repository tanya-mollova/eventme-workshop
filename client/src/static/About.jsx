export default function About() {
  return (
    <>
      <section className="page-header bg-tertiary pt-4">
            ...
            <div className="col-lg-7">
              <div className="section-title">
                ...
                <h2 className="h1 mb-4">
                  Bringing the world together <br /> through live experiences
                </h2>
                <div className="content pe-0 pe-lg-5">
                  <p className="lead">
                    From the most diverse events on the planet to simple
                    business meetings, brands have placed their trust in us to
                    create online and in-person events using our app.
                  </p>
                  <p>
                    Thrilled with the outstanding results, event leaders find
                    their way back to our platform to make every event
                    sensational.
                  </p>
                </div>
              </div>
        ...
        <div className="container">
          <div className="row justify-content-around">
            <div className="col-lg-5">
              ...
              <p className="lead">
                EventME is a global self-service ticketing platform for live
            ...
            <div className="col-lg-5">
              ...
              <p className="lead">
                Empowering Events with Ease, Scalability, and Security—Eventify
          ...
          <div className="row justify-content-center">
            <div className="col-lg-4 col-md-6 mb-5 mb-lg-0 text-center icon-box-item">
              <div className="icon icon-lg bg-transparent mb-4">
                <i className="fa-solid fa-earth-oceania text-primary"></i>
              </div>
              <h3>Events</h3>
              <p className="px-lg-5">5K+ total events in nearly 10 countries</p>
            </div>
            <div className="col-lg-4 col-md-6 mb-5 mb-lg-0 text-center icon-box-item">
              <div className="icon icon-lg bg-transparent mb-4">
              ...
              <h3>Creators</h3>
              <p className="px-lg-5">850 creators</p>
            </div>
            <div className="col-lg-4 col-md-6 mb-5 mb-lg-0 text-center icon-box-item">
              <div className="icon icon-lg bg-transparent mb-4">
              ...
              <h3>Tickets</h3>
              <p className="px-lg-5">30K total tickets</p>
            </div>
          </div>
        </div>
      </section>
